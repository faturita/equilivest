...
Preliminary results show that for the (1) experiment, on Figure \ref{fig:vestibular}), the value of pitch angles can be used to determine a breakpoint where the fall is inevitable (black vertical line, marked as 1*).   Results from experiment number (2) in Figure \ref{fig:gait} show that the gait cycle is clearly visible from raw acceleration data.
